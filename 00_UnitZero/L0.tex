...
\begin{align*}
    \tikzmarknode{matchS}{\frac{d}{dt}}\Bigg(\mu(t)y\Bigg)&=\frac{d\mu}{dt}y+\mu \frac{dy}{dt}
\end{align*}
Multiply the original equation by $\mu$:
\begin{align*}
    \tikzmarknode{originals}{\mu}\Bigg(\frac{dy}{dt}+p(t)y&=q(t) \Bigg) \\
    \mu\frac{dy}{dt}+\mu p(t)y&=\mu q(t)
\end{align*}
...
\begin{tikzpicture}[overlay, remember picture]
    \draw[<-, >=Latex, red, thick] (qt.south) 
        ...
        -- (turnPoint2 |- eq.west)  % Go Up (keep x of turnPoint, get y of matchE)
