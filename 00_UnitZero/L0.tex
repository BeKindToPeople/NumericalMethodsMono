...
In the form $F\Bigg(t,y,\frac{dy}{dt},\frac{d^2y}{dt^2}\Bigg)=0$ we have only moved all things in the container to one side. Using my rediculosu example from before.\\
